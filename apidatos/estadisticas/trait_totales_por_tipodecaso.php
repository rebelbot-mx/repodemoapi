...
trait trait_totales_por_tipodecaso {




    function buscarTotales_tipodecaso( $fi, $ff, $tipo ) {
        ...
        foreach ($matriz_tipodecaso as  $value) {
            ...
            $SQL_CONSULTA_NIVELS = "SELECT count(*) FROM incidente i join valoracionintegral vi on vi.incidenteid = i.id where vi.tipodecaso like '". $value ."'";
